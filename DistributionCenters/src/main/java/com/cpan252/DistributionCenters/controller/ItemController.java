...
public class ItemController {
    ...
    @PostMapping
    public String searchItemBrandAndName(@ModelAttribute ItemDTO itemDTO, Model model, @RequestParam("brand") String brand) {
        model.addAttribute("items", itemRepository.findByBrandFromAndName(Item.Brand.valueOf(brand),
                itemDTO.getName()));
        return "items";
    }
